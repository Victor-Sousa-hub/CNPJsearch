data = {
    ...
    "atualizado_em": "2024-10-29T09:29:01.000Z",
    "porte": {
      "id": "05",
      "descricao": "Demais"
    },
    ...
    "socios": [
      {
        ...
        "atualizado_em": "2024-10-12T03:00:00.000Z",
        "pais_id": "1058",
        "qualificacao_socio": {
          "id": 10,
          "descricao": "Diretor "
    ...
    "estabelecimento": {
      ...
      "inscricoes_estaduais": [
        {
          "inscricao_estadual": "092216463",
          "ativo": false,
          "atualizado_em": "2024-10-31T00:00:00.000Z",
          "estado": {
            "id": 16,
            "nome": "Pernambuco",
            "sigla": "PE",
        ...
        },
        {
          ...
          "ativo": true,
          "atualizado_em": "2024-11-02T04:16:03.845Z",
          "estado": {
            "id": 19,
            "nome": "Rio de Janeiro",
            "sigla": "RJ",
        ...
        },
        {
          ...
          "ativo": true,
          "atualizado_em": "2024-11-09T00:00:00.000Z",
          "estado": {
            "id": 23,
        ...
        },
        {
          ...
          "ativo": true,
          "atualizado_em": "2024-11-13T00:00:00.000Z",
          "estado": {
            "id": 26,
            "nome": "São Paulo",
            "sigla": "SP",
...
// Acessar o campo "atividade_principal" corretamente
const atividadePrincipal = data.estabelecimento?.atividade_principal;

if (atividadePrincipal) {
    console.log("Atividade Principal:", atividadePrincipal);
    console.log("Descrição:", atividadePrincipal.descricao);
    console.log("Código:", atividadePrincipal.subclasse);
} else {
    console.log("Atividade principal não encontrada.");
}